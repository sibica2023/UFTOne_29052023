/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘APITest_Demo.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity11Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>c9f2f2a6-5625-4b05-93cd-ff9e999e04be</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>City_Name</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>True</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value></Value></QueryParameter><QueryParameter><Name>TableStructure</Name><Value>FromCity,String,|ToCity,String,</Value></QueryParameter><QueryParameter><Name>TableContents</Name><Value>London|Paris^Denver|Frankfurt</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.dataSourceNameToDataSource.Add("City_Name", _flow.DataFetchActivity11);
            ...
            binding_setter3 = new StringFormaterDecorator(binding_setter3,"{Step.DataFetchActivity11.OutTable}");
            bind_dir3 = new BindDirection(_flow.DataFetchActivity11,binding_getter3,binding_setter3,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity12.InDirections.Add(bind_dir3);
            ...
            VTDPropertyInfoBase pi8 = new VTDPropertyInfoBase("InTable");
            ...
            this.DataCursorActivity15.InDirections.Add(bind_dir4);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><GetFlightOrders xmlns=""HP.SOAQ.SampleApp""><FlightsDetails><OrderNumber>91</OrderNumber></FlightsDetails></GetFlightOrders></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><DeleteFlightOrder xmlns=""HP.SOAQ.SampleApp""><OrderNumber>{Step.InputProperties.StServiceCallActivity5.Body.GetFlightOrders.FlightsDetails.OrderNumber}</OrderNumber></DeleteFlightOrder></Body></Envelope>");
            ...
            _flow.StServiceCallActivity7.Name = @"DeleteFlightOrder";
            ...
            _flow.StServiceCallActivity7.TransportProtocol.SOAPProperties.SoapAction = @"HP.SOAQ.SampleApp/IFlightsSoapService/DeleteFlightOrder";
            ...
            _flow.StServiceCallActivity7.Operation = @"DeleteFlightOrder";
            ...
            VTDPropertyInfoBase pi9 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrders'][1]/*[local-name(.)='FlightsDetails'][1]/*[local-name(.)='OrderNumber'][1]");
            ...
            bind_dir5 = new BindDirection(_flow.StServiceCallActivity5,binding_getter5,binding_setter5,BindTargetType.ToInProperty);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.City_Name.FromCity}</DepartureCity><ArrivalCity>{DataSource.City_Name.ToCity}</ArrivalCity></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi11 = new VTDPropertyInfoBase("FromCity");
            VTDBaseGetter binding_getter6 = new VTDObjectGetter(pi11);
            VTDPropertyInfoBase pi12 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter6 = new VTDXPathSetter(pi12,XmlTypeCode.String);
            binding_setter6 = new StringFormaterDecorator(binding_setter6,"{DataSource.City_Name.FromCity}");
            bind_dir6 = new BindDirection(this.DataCursorActivity15,binding_getter6,binding_setter6,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir6);
            VTDPropertyInfoBase pi13 = new VTDPropertyInfoBase("ToCity");
            VTDBaseGetter binding_getter7 = new VTDObjectGetter(pi13);
            VTDPropertyInfoBase pi14 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter7 = new VTDXPathSetter(pi14,XmlTypeCode.String);
            binding_setter7 = new StringFormaterDecorator(binding_setter7,"{DataSource.City_Name.ToCity}");
            bind_dir7 = new BindDirection(this.DataCursorActivity15,binding_getter7,binding_setter7,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity9.InDirections.Add(bind_dir7);
